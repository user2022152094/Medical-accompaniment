    ...
    <el-table-column label="创建时间">
      <template #default="scope">
        <div class="flex-box">
          ...
          <span style="margin-left: 5px;">{{dayjs(scope.row.create_time).format('YYYY-MM-DD')}}</span>
        </div>
      </template>
    </el-table-column>
  ...
  >
    ...
    >
      ...
      <el-form-item label="头像" prop="avatar">
        <el-button v-if="!form.avatar" type="primary" @click="dialogImgVisible=true">点击上传头像</el-button>
        <el-image
          v-else
          :src="form.avatar"
...
const selectTableData = ref([])  // 定义选择要删除的数据
